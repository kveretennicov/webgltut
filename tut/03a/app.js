App = function () {
  ...
  var start = function (window, canvasId) {
    ...
    var computePositionOffset = function () {

      var loopDurationS = 5.0;
      var scale = Math.PI * 2 / loopDurationS;

      var currTimeThroughLoopS = (getElapsedTimeMs() / 1000.0) % loopDurationS;
      var xOffset = Math.cos(currTimeThroughLoopS * scale) * 0.5;
      var yOffset = Math.sin(currTimeThroughLoopS * scale) * 0.5;
    ...
    var adjustVertexPositions = function (xOffset, yOffset) {

      var newData = new Float32Array(vertexPositions);
    ...
    var render = function () {
      ...
      var offset = computePositionOffset();
      adjustVertexPositions(offset.x, offset.y);
